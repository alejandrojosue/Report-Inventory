...
let URLS = {
    app: [
        ...
        './js/products/create.js',
        './js/sales/create.js',
        './js/expenses/create.js',
        './js/products/edit.js',
        './js/sales/edit.js',
        './js/expenses/edit.js',
        './js/products/index.js',
        './js/sales/index.js',
        './js/expenses/index.js',
        './assets/img/expense.jpg',
        './assets/img/sale.jpg',
        './assets/img/report.jpg',
        './assets/icons/icono16x16.png',
        './assets/icons/icono32x32.png',
        './assets/icons/icono64x64.png',
        './assets/icons/icono128x128.png',
        './assets/icons/icono192x192.png',
        './assets/icons/icono256x256.png',
        './assets/icons/icono384x384.png',
        './assets/icons/icono512x512.png'
    ],
    vendor: [
